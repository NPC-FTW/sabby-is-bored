      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-8">
            ...
            <span className="text-sm font-medium text-primary">AI-Powered Creative Tools</span>
          </div>

          {/* Headline */}
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">
            Unleash Your
            <span className="block gradient-text">Creative Power</span>
          </h1>

          {/* Subheadline */}
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            Sabby Is Bored AI Suite provides cutting-edge AI tools to spark your creativity. Create stunning content, generate visuals, and explore ideas faster than ever.
          </p>
